...
export class PokemonService {
  ...
  async findOne(term: string) {
    ...
    if (!pokemon)
      throw new NotFoundException(`Pokemon con _Id, Name o No "${term}" no encontrado`)
  ...
  private handleExceptions( error: any ) { 
    ...
    console.log(error);
    throw new InternalServerErrorException(`No fue posible crear el Pokemon - Revisar los logs`);
  }
}
